...
#spacex_df['LaunchSite']=spacex_df['Launch Site']
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig=px.pie(
            ...
            names = 'Launch Site',
            title = 'Breakdown of Successful Outcome by Launch Site'
        )
        return fig
    else:
        ...
        fig = px.pie(
            ...
            values='class count', 
            names='class', 
            title="Breakdown of Outcome Launches for {}".format(entered_site)
        )
        return fig
...
def get_scatter(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        fig=px.scatter(
            ...
            title = 'Success of Launches by Payload Mass for All Launch Sites'
        ...
        fig=px.scatter(
            ...
            y='class',
            color = 'Booster Version Category',
            title = 'Success of Launches by Payload Mass for {}'.format(entered_site)
        ).update_layout(xaxis_title='Payload Mass(kg)', yaxis_title='Launch Outcome')
        return fig
